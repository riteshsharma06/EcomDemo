    ...
    if([aImageUrls count] > 0) {
        ...
        for (int i = 0; i < [aImageUrls count]; i++) {
            ...
            if([[aImageUrls objectAtIndex:i] isKindOfClass:[UIImage class]]) {
                ...
                [imageView sd_setImageWithURL:[aImageUrls objectAtIndex:i] placeholderImage:[UIImage imageNamed:@"mii2"]];
                ...
                // [self.imageSource sd_setImageWithURL:imageUrl placeholderImage:[UIImage imageNamed:@"logo"]];
                [imageView sd_setImageWithURL:imageUrl placeholderImage:[UIImage imageNamed:@"mii2"]];
                //image source is responsible for image retreiving/caching, etc...
                //                [self.imageSource imageWithUrl:imageUrl
                //                                    completion:^(UIImage *image, NSError *error)
                //                 {
                //                     if(!error) [imageView sd_setImageWithURL:imageUrl placeholderImage:[UIImage imageNamed:@"logo"]];//should we handle error?
                //
